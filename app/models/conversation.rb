...
#  index_conversations_on_account_id_and_last_activity_at  (account_id,last_activity_at)
#  index_conversations_on_assignee_id_and_account_id       (assignee_id,account_id)
#  index_conversations_on_campaign_id                      (campaign_id)
#  index_conversations_on_contact_id                       (contact_id)
#  index_conversations_on_contact_inbox_id                 (contact_inbox_id)
#  index_conversations_on_ctwa_ad_id                       ((((additional_attributes -> 'ctwa_referral'::text) ->> 'ad_id'::text))) WHERE ((additional_attributes -> 'ctwa_referral'::text) IS NOT NULL)
#  index_conversations_on_ctwa_source                      ((((additional_attributes -> 'ctwa_referral'::text) ->> 'source'::text))) WHERE ((additional_attributes -> 'ctwa_referral'::text) IS NOT NULL)
